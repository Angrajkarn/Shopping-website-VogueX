...
const occasions = [
    {
        ...
        link: "/products?category=Women&subcategory=Party Wear"
    },
    {
        id: 2,
        title: "Office Chic",
        ...
        link: "/products?category=Men&subcategory=Formal Wear"
    },
    {
        id: 3,
        ...
        link: "/products?category=Men&subcategory=Vacation"
    },
    {
        id: 4,
        title: "Active Life",
        ...
        link: "/products?category=Women&subcategory=Activewear"
    }
]
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {occasions.map((item, idx) => (
                        <Link href={item.link} key={item.id} className="block w-full h-full">
                            <motion.div
