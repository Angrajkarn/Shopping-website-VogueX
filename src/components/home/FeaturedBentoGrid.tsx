    ...
    return (
        <section className="py-12 container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
                ...
                {/* Large/Tall item */}
                <Link href="/products?category=streetwear" className="md:col-span-2 md:row-span-2 relative rounded-3xl overflow-hidden group cursor-pointer block">
                    <motion.div
                ...
                {/* Top Right Landscape */}
                <Link href="/products?category=fragrances" className="md:col-span-2 relative rounded-3xl overflow-hidden group cursor-pointer min-h-[250px] block">
                    <motion.div
                        whileHover={{ scale: 0.98 }}
                        className="h-full w-full"
                    >
                ...
                {/* Bottom Center */}
                <Link href="/products?category=mens-shoes" className="relative rounded-3xl overflow-hidden group cursor-pointer min-h-[250px] block">
                    <motion.div
                        whileHover={{ scale: 0.98 }}
                        className="h-full w-full"
                    >
                ...
                {/* Bottom Right */}
                <Link href="/products?category=womens-bags" className="relative rounded-3xl overflow-hidden group cursor-pointer min-h-[250px] block">
                    <motion.div
                        whileHover={{ scale: 0.98 }}
                        className="h-full w-full"
                    >
